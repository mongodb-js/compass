...
- [**@mongodb-js/compass-query-history**](packages/compass-query-history): The query history sidebar of Compass
...
- [**@mongodb-js/compass-sidebar**](packages/compass-sidebar): undefined
