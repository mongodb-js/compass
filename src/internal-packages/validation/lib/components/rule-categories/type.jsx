...
class RuleCategoryType extends React.Component {
  ...
  render() {
    ...
    return (
      <BSONTypeSelector typeNumber={typeNumber} serverVersion={this.props.serverVersion} isDisabled={!this.props.isWritable} onTypeClicked={this.onTypeClicked.bind(this)} />
    );
  }
}
