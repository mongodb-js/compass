 ...
 */
var ConnectionItemView = ListItemView.extend({
  ...
  template: require('../sidebar/list-item.jade'),
  initialize: function() {
    this.displayProp = 'name';
  }
  // onClick: function(evt) {
  //   this.parent.parent.onItemClick(evt, this);
  // },
  // onDoubleClick: function(evt) {
  //   this.parent.parent.onItemDoubleClick(evt, this);
  // }
});
...
module.exports = ConnectionItemView;
