...
const COLLATION_OPTIONS = [
  {
    ...
    values: [
      ...
      {value: 'bn@collation=traditional', label: 'bn - Bengali - traditional'},
      ...
      {value: 'zh_Hant@collation=stroke', label: 'zh_Hant - Chinese (Traditional) - stroke'},
      ...
      {value: 'en_US_POSIX', label: 'en_US_POSIX - English (United States, Computer)'},
      ...
      {value: 'fi_FI@collation=traditional', label: 'fi_FI - Finnish - traditional'},
      ...
      {value: 'de_AT@collation=phonebook', label: 'de_AT - German (Austria) - phonebook'},
      ...
      {value: 'kn@collation=traditional', label: 'kn - Kannada - traditional'},
      ...
      {value: 'nn@collation=search', label: 'nn - Norwegian Nynorsk - search'},
      ...
      {value: 'sr_Latn@collation=search', label: 'sr_Latn - Serbian (Latin) - search'},
      ...
      {value: 'es@collation=traditional', label: 'es - Spanish - traditional'},
      ...
      {value: 'vi@collation=traditional', label: 'vi - Vietnamese - traditional'},
...
module.exports = {LOADING_STATE, COLLATION_OPTIONS};
