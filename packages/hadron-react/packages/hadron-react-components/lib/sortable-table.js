...
SortableTable.propTypes = {
   ...
   */
  rows: React.PropTypes.arrayOf(React.PropTypes.oneOfType([React.PropTypes.object, React.PropTypes.array])),
  /**
   ...
   * @type {Number}
   */
  sortColumn: React.PropTypes.oneOfType([React.PropTypes.number, React.PropTypes.string]),
  /**
