...
const tests = [
  {
    ...
    connectionString: 'mongodb://mongodb1.example.com:27317,mongodb2.example.com:27017/' +
      '?replicaSet=mySet&readPreference=nearest&authSource=authDB&ssl=true'
  },
  {
    description: 'for ATLAS connection with ssl',
    connectionString: 'mongodb://ADMINUSER:A_MUCH_LONGER_PASSWORD_should_be_more_secure...@' +
  ...
  },
  {
    ...
    connectionString: 'mongodb://localhost:27017/?compressors=snappy%2Czlib&' +
      'readPreference=primary&ssl=false'
  },
  {
    description: 'with zlibCompressionLevel',
    connectionString: 'mongodb://localhost:27017/?zlibCompressionLevel=9&' +
      'readPreference=primary&ssl=false'
  },
  {
    description: 'with maxPoolSize, minPoolSize, maxIdleTimeMS, waitQueueMultiple and waitQueueTimeoutMS',
    connectionString: 'mongodb://localhost:27017,localhost:27018,localhost:27019/databasename?' +
  ...
  },
  {
    ...
    connectionString: 'mongodb://db0.example.com:27017,db1.example.com:27017,db2.example.com:27017/?' +
      'replicaSet=myRepl&readConcernLevel=majority&readPreference=primary&ssl=false'
  },
  {
    description: 'with readPreference, maxStalenessSeconds and readPreferenceTags',
    connectionString: 'mongodb://mongos1.example.com:27017,mongos2.example.com:27017/?' +
  ...
  },
  {
    ...
    connectionString: 'mongodb://%40rlo:w%40of@localhost:27017/dogdb?authSource=catdb&' +
    'readPreference=primary&authMechanism=SCRAM-SHA-1&ssl=false'
  },
  {
    description: 'with authMechanismProperties and gssapiServiceName',
    connectionString: 'mongodb://%40rlo:w%40of@localhost:27017/?' +
  ...
  {
    description: 'with localThresholdMS, serverSelectionTimeoutMS and heartbeatFrequencyMS',
    connectionString: 'mongodb://localhost:27017/?replicaSet=test&w=1&' +
  ...
  },
  {
    ...
    connectionString: 'mongodb://a:27017/?readPreference=primary&' +
      'serverSelectionTryOnce=false&ssl=false'
  },
  {
    description: 'with appName',
    connectionString: 'mongodb://localhost:27017/?readPreference=primary&appname=foo&ssl=false'
  },
  {
    description: 'with retryWrites',
    connectionString: 'mongodb://hostname:27017/?readPreference=primary&retryWrites=true&ssl=false'
  },
  {
    description: 'with uuidRepresentation',
    connectionString: 'mongodb://foo:27017/?readPreference=primary&uuidRepresentation=csharpLegacy&ssl=false'
  }
];

describe('connection model', () => {
  describe(
    'should parse a connection string and build the same string back',
    function() {
      tests.forEach(function(test) {
        const runTest = (done) => Connection.from(test.connectionString, (error, result) => {
