    ...
    <g fill="none" fillRule="evenodd" transform="translate(1 1)">
      <g transform="translate(23.125 26.25)">
        <polygon
          ...
          strokeWidth="1.75"
          points=".313 22.813 22.813 22.813 11.563 .313"
        />
        <path
          stroke="#116149"
          strokeLinecap="round"
          strokeLinejoin="round"
          strokeWidth="1.75"
          d="M11.5625,9.6875 L11.5625,16.25"
        />
        <path
          fill="#116149"
          d="M11.5625,18.125 C11.045,18.125 10.625,18.545 10.625,19.0625 C10.625,19.58 11.045,20 11.5625,20 C12.08,20 12.5,19.58 12.5,19.0625 C12.5,18.545 12.08,18.125 11.5625,18.125 Z"
        />
      </g>
      <g
        stroke="#116149"
