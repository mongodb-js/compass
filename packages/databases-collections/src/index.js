...
import RenameCollectionPlugin from './components/rename-collection-plugin';
import RenameCollectionStore from './stores/rename-collection';
...
// Rename collection modal plugin.
const RENAME_COLLECTION_ROLE = {
  name: 'Rename Collection',
  component: RenameCollectionPlugin,
};
...
function activate(appRegistry) {
  ...
  appRegistry.registerRole('Global.Modal', RENAME_COLLECTION_ROLE);
  appRegistry.registerStore(
    'CollectionsPlugin.RenameCollectionsStore',
    RenameCollectionStore
  );
}
...
function deactivate(appRegistry) {
  ...
  appRegistry.deregisterRole('Global.Modal', RENAME_COLLECTION_ROLE);
  ...
  appRegistry.deregisterStore('CollectionsPlugin.RenameCollectionsStore');
