...
const CardHeader = ({
  ...
  const _className = classnames(styles['component-header'], className);

  const _headerInnerClassName = classnames(styles['component-header-inner']);

  const _titleClassName = classnames(styles['component-header-title']);

  const _actionsClassName = classnames(styles['component-header-actions'], {
