...
const fromDB = [
  {
    ...
    'usageHost': 'computername.local:27017', 'usageCount': 10,
    'usageSince': '2019-02-08T14:40:13.609Z', 'size': 94208
  }
];

const defaultSort = [
  {
    'ns': 'citibike.trips', 'key': {'aaaa': -1}, 'name': 'AAAA', 'size': 4096,
    'usageCount': 4, 'usageSince': '2019-02-08T14:39:56.285Z',
    'usageHost': 'computername.local:27017', 'version': 2, 'extra': {
      'background': false, 'expireAfterSeconds': 300,
  ...
  {
    'ns': 'citibike.trips', 'key': {'bbbb.abcd': 1}, 'name': 'BBBB', 'size': 94208,
    'usageCount': 10, 'usageSince': '2019-02-08T14:40:13.609Z',
    'usageHost': 'computername.local:27017', 'version': 2,
    'extra': {
      'background': false, 'collation': {'locale': 'ar', 'caseLevel': true,
        'caseFirst': 'lower', 'strength': 3, 'numericOrdering': false,
        'alternate': 'non-ignorable', 'maxVariable': 'space',
  ...
  {
    'ns': 'citibike.trips', 'key': {'cccc0': -1, 'cccc1': '2dsphere', 'cccc2': 1},
    'name': 'CCCC', 'size': 4096, 'usageCount': 5,
  ...
  {
    'ns': 'citibike.trips', 'key': {'_id': 1}, 'name': '_id_', 'size': 135168,
    'usageCount': 6, 'usageSince': '2019-02-08T10:21:49.176Z',
    'usageHost': 'computername.local:27017', 'version': 2, 'extra': {},
...
const usageSort = [
  {
    'name': 'AAAA',
    'usageCount': 4,
    'ns': 'citibike.trips', 'key': {'aaaa': -1}, 'size': 4096,
  ...
  },
  {
    ...
    'ns': 'citibike.trips', 'key': {'cccc0': -1, 'cccc1': '2dsphere', 'cccc2': 1},
    'size': 4096,
    'usageSince': '2019-02-08T14:38:56.147Z', 'usageHost': 'computername.local:27017',
  ...
  },
  {
    'name': '_id_',
    'usageCount': 6,
    'ns': 'citibike.trips', 'key': {'_id': 1}, 'size': 135168,
  ...
  },
  {
    'name': 'BBBB',
    'usageCount': 10,
    'ns': 'citibike.trips', 'key': {'bbbb.abcd': 1},
    'size': 94208, 'usageSince': '2019-02-08T14:40:13.609Z',
    'usageHost': 'computername.local:27017', 'version': 2, 'extra': {
      'background': false, 'collation': {'locale': 'ar', 'caseLevel': true,
        'caseFirst': 'lower', 'strength': 3, 'numericOrdering': false,
        'alternate': 'non-ignorable', 'maxVariable': 'space',
