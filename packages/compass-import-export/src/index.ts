...
// TODO(COMPASS-6582): Rename new store and remove old.
import oldExportStore from './stores/old-export-store';
...
function activate(appRegistry: AppRegistry): void {
  ...
  appRegistry.registerStore('ExportModal.Store', oldExportStore);
