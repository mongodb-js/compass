...
class ProgressBar extends PureComponent {
  ...
  renderStats() {
    const { docsTotal, docsWritten, progressLabel, progressTitle, isAggregation } = this.props;
   ...
   */
  render() {
    const { message, status, docsProcessed, docsTotal, docsWritten, isAggregation } =
      this.props;
