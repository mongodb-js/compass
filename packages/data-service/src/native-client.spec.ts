...
describe('NativeClient', function () {
  ...
  before(function (done) {
    ...
    const callback = (err: any) => {
      ...
      adminDb.addUser('dba-admin', 'password', { roles: ['root'] }, done);
    };
  ...
  describe('#connect', function () {
    context('when mocking connection-model', function () {
      ...
      it('sets .connectionOptions after successful connection', function (done) {
        ...
        expect(mockedClient.connectionOptions).to.be.undefined;
  ...
  describe('#find', function () {
    ...
    context('when array sort is provided', function () {
      it('returns documents with correct sort order', function (done) {
        ...
        client.find('data-service.test', {}, { sort }, function (error, docs) {
  ...
  describe('#createIndex', function () {
    after(function (done) {
      const testCollection = client.database.collection('test');
   ...
   */
  describe('INT-1294: Collection name with `.`', function () {
    const ns = 'mydb.events.periodic';
    it('should return the correct databaseName', function () {
      expect(client._databaseName(ns)).to.equal('mydb');
    });

    it('should return the correct collectionName', function () {
