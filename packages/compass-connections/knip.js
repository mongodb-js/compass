...
module.exports = {
  ...
  entry: [
    ...
    'src/**/*.spec.{ts,tsx}',
    // TestEnvCurrentConnectionContext is exported for use by configs/testing-library-compass
    // (cross-package usage that knip can't detect within per-package analysis)
    'src/connection-info-provider.tsx',
    // createDefaultConnectionInfo is imported by configs/testing-library-compass via direct src path
