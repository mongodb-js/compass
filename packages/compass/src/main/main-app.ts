// Note: setupHadronDistribution() is invoked from the dispatcher in index.ts
// before this module is required, so the process.env vars are already in
// place. Do not call it again here.
