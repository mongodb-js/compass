...
describe('branches', function () {
  ...
  describe('hasVersion', function () {
    it('returns true if matching', function () {
      expect(hasVersion('1.22-releases', '1.22.0')).to.be.true;

      expect(hasVersion('1.22-releases', '1.22.1')).to.be.true;

      expect(hasVersion('1.22-releases', '1.22.1-beta.0')).to.be.true;
    });

    it('returns false if not matching', function () {
      expect(hasVersion('1.22-releases', '1.21.0')).to.be.false;

      expect(hasVersion('1.22-releases', '1.21.0-beta.0')).to.be.false;

      expect(hasVersion('1.22-releases', '1.23.0')).to.be.false;

      expect(hasVersion('1.22-releases', '1.23.0-beta.0')).to.be.false;
    });
  });
