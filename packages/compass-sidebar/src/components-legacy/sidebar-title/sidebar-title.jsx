...
const ExpandedTitle = ({ connectionInfo }) => {
  return (
...
const SidebarTitle = ({
  ...
  return (
    ...
    >
      {isSidebarExpanded ? (
        <ExpandedTitle connectionInfo={connectionInfo} />
      ) : (
        <CollapsedTitle connectionInfo={connectionInfo} />
      )}
    </div>
  );
};
