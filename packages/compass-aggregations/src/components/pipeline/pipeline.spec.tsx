...
describe('Pipeline search indexes polling', function () {
  ...
  describe('when enableSearchActivationProgramP1 is false (not in experiment variant)', function () {
    it('does not call any polling functions', async function () {
      // Without wrapWithExperimentProvider, useSearchActivationProgramP1 returns false
