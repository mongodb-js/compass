...
/**
 * Helper hook to run a setState sync logic in the render method when some
 * component prop changes. This is recommended over calling `setState` directly
 * inside effects, but _is still considered an antipattern_. Please refer to the
 * React documentation for the guidance around how to avoid this pattern.
 *
 * @see {@link
