...
type ExplainCase = {
  ...
  // Note that most of these are optional for now and not used by our existing
  // prompt yet. They are handy in case you want to test to see how much
  // difference it makes. (Note that you would also have to edit the explain
  // plan prompt as well as buildPrompt() below accordingly. I'm keeping them
  // here as reference.)
  indexes?: string;
  query?: string;
  aggregation?: string;
