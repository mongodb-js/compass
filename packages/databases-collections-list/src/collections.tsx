...
const COLLECTION_CARD_HEIGHT =
  /* content height (with paddings and border) */ 243 +
...
const CollectionsList: React.FunctionComponent<{
  ...
  return (
    <ItemsGrid
      items={collections}
      itemType="collection"
      itemWidth={COLLECTION_CARD_WIDTH}
      itemHeight={COLLECTION_CARD_HEIGHT}
      sortBy={[
      ...
      renderItem={({ item: coll, onItemClick, onDeleteItemClick }) => {
        const data =
          coll.type === 'view'
