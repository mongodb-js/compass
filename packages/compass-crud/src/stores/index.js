...
const debug = require('debug')('mongodb-compass:stores:compass-crud');

/**
 * Compass Crud store.
 */
const CompassCrudStore = Reflux.createStore({
  /**
   ...
   */
  listenables: CompassCrudActions,
  ...
  /**
   * Initialize the Compass Crud store state. The returned object must
  ...
  storeDidUpdate(prevState) {
    debug('CompassCrud store changed from', prevState, 'to', this.state);
  }
});

module.exports = CompassCrudStore;
