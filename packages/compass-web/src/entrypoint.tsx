...
const CompassWeb = ({
  ...
  // FORCE ENABLE for testing - remove this line in production
  const forceEnabledForTesting = true;
  const finalMyQueriesEnabled = forceEnabledForTesting || isMyQueriesEnabled;
