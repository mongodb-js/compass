...
// TODO: eventually we can move these translations out into a string template
const TRANSLATE = {
...
Visitor.prototype.visitFuncCallExpression = function(ctx) {
  ...
  const translated = lhsType.id in TRANSLATE ? TRANSLATE[lhsType.id] : lhsType.id;
  return this.emitType(translated, ctx);
};
