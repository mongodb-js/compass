...
module.exports = (superclass) => class ExtendedVisitor extends superclass {
  ...
  visitBSONCodeConstructor(ctx) {
    ...
    if (argList.length === 2) {
      ...
      if (argList[1].type !== this.Types._object) {
  ...
  visitBSONTimestampConstructor(ctx) {
    ...
    if (argList[0].type !== this.Types._integer) {
      throw new SemanticTypeError({
    ...
    if (argList[1].type !== this.Types._integer) {
      throw new SemanticTypeError({
  ...
  visitBSONDBRefConstructor(ctx) {
    ...
    if (args.length === 3) {
      ...
      if (args[2].type !== this.Types._string) {
        throw new SemanticTypeError({
