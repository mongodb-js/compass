...
const JavaParserListener = require('../lib/JavaParserListener.js');

/**
 * This Listener walks the AST generated by the transformers and produces code.
 */
function Listener() {
  JavaParserListener.JavaParserListener.call(this);
  return this;
}

Listener.prototype = Object.create(JavaParserListener.JavaParserListener.prototype);
