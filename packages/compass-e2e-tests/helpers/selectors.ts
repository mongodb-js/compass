...
export const ConnectingOIDCDeviceAuthFlowVerificationUrl =
  '[data-testid="oidc-device-auth-flow-verification-url"]';
export const ConnectingOIDCDeviceAuthFlowUserCode =
...
export const ConnectionFormOIDCOptionsAccordion =
  '[data-testid="authentication-oidc-options-accordion"]';
export const ConnectionFormInputOIDCDeviceAuthCheckbox =
