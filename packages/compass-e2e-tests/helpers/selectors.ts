...
export const MockDataGeneratorLoader = `${MockDataGeneratorModal} [data-testid="raw-schema-confirmation-loader"]`;
export const MockDataGeneratorSchemaError = `${MockDataGeneratorModal} [data-testid="schema-analysis-error-banner"]`;
export const MockDataGeneratorRetry = `${MockDataGeneratorModal} [data-testid="retry-analysis-button"]`;
