...
describe('DocumentStatsItem [Component]', function () {
  ...
  describe('when time-series is true', function () {
    ...
    it('does not render the count', function () {
      expect(screen.queryByTestId('document-count-collection-stats-item-label-primary')).to.not.exist;
    });
    ...
    it('renders avg document size', function () {
      expect(screen.queryByTestId('avg-document-size-collection-stats-item-label')).to.not.exist;
    });
  });
});
