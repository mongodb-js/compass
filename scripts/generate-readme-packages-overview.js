...
const pluginNames = [
  ...
  '@cloud-mongodb-js/compass-aggregations',
  '@cloud-mongodb-js/compass-export-to-language',
  '@mongodb-js/compass-collection',
  '@cloud-mongodb-js/compass-crud',
  ...
  '@cloud-mongodb-js/compass-query-bar',
  '@mongodb-js/compass-schema',
  '@mongodb-js/compass-schema-validation',
  '@cloud-mongodb-js/compass-serverstats',
