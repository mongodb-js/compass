...
var platform = require(path.join(__dirname, '..', 'tasks', process.platform + '.js'));

var BINARY = path.resolve(__dirname, '../' + platform.ELECTRON);
console.log('Using electron binary at', BINARY);
